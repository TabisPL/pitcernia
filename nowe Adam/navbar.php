  ...
  <div class="container">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
        ...
        <?php if (!isset($_SESSION['UzytkownikID'])) {
          echo '<li><a href="../Login/login.php" class="nav-link px-2 text-white">KOSZYK</a></li>';
          echo '<li><a href="../Login/login.php" class="nav-link px-2 text-white">MOJE KONTO</a></li>';
          } else {
              echo '<li><a href="../koszyk.php" class="nav-link px-2 text-white">KOSZYK</a></li>';
              echo '<li><a href="../UserPanel/userPanel.php" class="nav-link px-2 text-white">MOJE KONTO</a></li>';
          }
        ?>
      </ul>
